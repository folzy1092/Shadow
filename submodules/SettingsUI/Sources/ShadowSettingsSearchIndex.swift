...
enum ShadowSettingsSearchIndex {
    static let items: [ShadowSettingsSearchItem] = [
        ...
        ShadowSettingsSearchItem(destination: .customization, entryId: 99, title: "0.5× на кружках", description: "Переключать заднюю камеру кружка на сверхширокоугольный модуль", keywords: "round video кружок 0.5 ultra wide сверхширокая камера зум"),
